<%-- 
    Document   : Bienvenida
    Created on : 8 abr. 2021, 06:57:33
    Author     : Akamegakill
--%>
                    ...
                    <div class="form-group">
                        ...
                        <center>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <button type="submit" class="btn btn-success" name="sumar">Sumar</button>
                                <button type="submit" class="btn btn-info" name="restar">Restar</button>
